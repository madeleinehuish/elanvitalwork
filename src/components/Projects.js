...
class Projects extends React.Component {
  ...
  render() {
    return (
      <section className="backDrop" ref="theProjectsAnchor">
        ...
        <div className="imgDiv">
          <img src={projectPic3} alt="stand alone unit"></img>
        </div>
        <div className="offset-by-one ten columns projectTextBlock">
        ...
        <div className="imgDiv">
          <img src={projectPic4} alt="stand alone unit"></img>
        </div>
        <div className="offset-by-one ten columns projectTextBlock">
        ...
        <div className="imgDiv">
          <img src={projectPic5} alt="stand alone unit"></img>
        </div>
        <div className="offset-by-one ten columns projectTextBlock">
        ...
        <div className="imgDiv">
          <img src={projectPic6} alt="buddy locker"></img>
        </div>
        <div className="offset-by-one ten columns projectTextBlock">
        ...
        <div className="imgDiv">
          <img src={projectPic7} alt="portable washer"></img>
        </div>
        <div className="imgDiv">
          <img src={projectPic8} alt="portable washer"></img>
        </div>
      </section>
      );
